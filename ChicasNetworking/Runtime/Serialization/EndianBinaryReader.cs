...
namespace Lovatto.Chicas.Internal
{
    ...
    public partial class EndianBinaryReader : IDisposable
    {
        ...
        /// <summary>
        ///     Reads a 32-bit signed integer array from the stream, using the bit converter
        ///     for this reader. 4 bytes are read per array element + 2 bytes for length header.
        /// </summary>
        /// <returns>The 32-bit integer read</returns>
